      ...
      <PdfContainer>
        <Table data={this.state.data}>
          ...
          <TableBody>
            ...
            <DataTableCell
              getContent={(r: HumanRow) => r.dob.toLocaleString()}
            />
            <DataTableCell getContent={(r: HumanRow) => r.country} />
            <DataTableCell
              getContent={(r: HumanRow) => (
                <Table data={[r]}>
                  <TableBody
                    textAlign={"center"}
                    includeTopBorder={false}
                  ...
                  >
                    <DataTableCell
                      getContent={(r: HumanRow) => r.randomValues.one}
                    />
                    <DataTableCell
                      getContent={(r: HumanRow) => r.randomValues.two}
                    />
                    <DataTableCell
                      getContent={(r: HumanRow) => r.randomValues.three}
                    />
                    <DataTableCell
                      getContent={(r: HumanRow) => r.randomValues.four}
                    />
                  </TableBody>
                </Table>
              )}
